...
// Hotel's comment and detals
const hotelComment = document.querySelectorAll('.hotelComment')
const hotelDetail = document.querySelectorAll('.hotelDetail')

hotelComment.forEach(comment => {
    comment.addEventListener('click', () => {
        comment.parentElement.parentElement.parentElement.parentElement.classList.toggle("activeComment")
        if (comment.parentElement.parentElement.parentElement.parentElement.classList.contains("activeDetail")) {
            comment.parentElement.parentElement.parentElement.parentElement.classList.remove("activeDetail")
        }
    })
})

hotelDetail.forEach(detail => {
    detail.addEventListener('click', () => {
        detail.parentElement.parentElement.parentElement.parentElement.classList.toggle("activeDetail")
        if (detail.parentElement.parentElement.parentElement.parentElement.classList.contains("activeComment")) {
            detail.parentElement.parentElement.parentElement.parentElement.classList.remove("activeComment")
        }
    })
})
